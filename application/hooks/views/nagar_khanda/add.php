    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Nagar Khanda Add</h3>
            </div>
            <?php echo form_open('nagar_khanda/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nagar_khanda_name" value="<?php echo $this->input->post('nagar_khanda_name'); ?>" class="form-control" id="nagar_khanda_name" />
