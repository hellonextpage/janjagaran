    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Upabasti Gramam Edit</h3>
            </div>
			<?php echo form_open('upabasti_gramam/edit/'.$upabasti_gramam['upabasti_gramam_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="basti_upamandal_id" class="form-control">
								...
								{
									$selected = ($basti_upamandal['basti_upamandal_id'] == $upabasti_gramam['basti_upamandal_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="upabasti_gramam_name" value="<?php echo ($this->input->post('upabasti_gramam_name') ? $this->input->post('upabasti_gramam_name') : $upabasti_gramam['upabasti_gramam_name']); ?>" class="form-control" id="upabasti_gramam_name" />
