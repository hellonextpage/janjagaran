    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Basti Upamandal Edit</h3>
            </div>
			<?php echo form_open('basti_upamandal/edit/'.$basti_upamandal['basti_upamandal_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="nagar_khanda_id" class="form-control">
								...
								{
									$selected = ($nagar_khanda['nagar_khanda_id'] == $basti_upamandal['nagar_khanda_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="basti_upamandal_name" value="<?php echo ($this->input->post('basti_upamandal_name') ? $this->input->post('basti_upamandal_name') : $basti_upamandal['basti_upamandal_name']); ?>" class="form-control" id="basti_upamandal_name" />
