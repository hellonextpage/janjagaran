    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Volunteer Edit</h3>
            </div>
			<?php echo form_open('volunteer/edit/'.$volunteer['volunteer_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="zilla_id" class="form-control">
								...
								{
									$selected = ($zilla['zilla_id'] == $volunteer['zilla_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="volunteer_name" value="<?php echo ($this->input->post('volunteer_name') ? $this->input->post('volunteer_name') : $volunteer['volunteer_name']); ?>" class="form-control" id="volunteer_name" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="mobile_no" value="<?php echo ($this->input->post('mobile_no') ? $this->input->post('mobile_no') : $volunteer['mobile_no']); ?>" class="form-control" id="mobile_no" />
