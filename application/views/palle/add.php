    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Palle Add</h3>
            </div>
            <?php echo form_open('palle/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="upabasti_gramam_id" class="form-control">
								...
								{
									$selected = ($upabasti_gramam['upabasti_gramam_id'] == $this->input->post('upabasti_gramam_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="palle_name" value="<?php echo $this->input->post('palle_name'); ?>" class="form-control" id="palle_name" />
