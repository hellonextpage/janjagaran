<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('vw_contact/add/'); ?>
			<div class="box-body">
				...
				<div class="col-md-6">
						...
						<select name="zilla" class="form-control" id="zilla" onchange="return cityData(this,'khanda')">
								...
								<?php foreach($zilla as $o){?>
									<option value="<?php echo $o['zilla_id'];?>"><?php echo $o['zilla_name'];?></option>
								<?php } ?>
							</select>
						</div>
					</div>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="contact_name" value="<?php echo ($this->input->post('contact_name') ? $this->input->post('contact_name') : ''); ?>" class="form-control" id="contact_name" />
						</div>
					</div>
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="occupation_id" class="form-control">
								...
								<?php foreach($occupation as $o){?>
									<option value="<?php echo $o['occupation_id'];?>" ><?php echo $o['occupation_name'];?></option>
								<?php } ?>
							</select>
						</div>
					</div>
						...
						<div class="form-group">
							<select name="contact_type_id" class="form-control">
								...
								<?php foreach($contact as $o){?>
									<option value="<?php echo $o['contact_type_id'];?>" ><?php echo $o['contact_type_name'];?></option>
								<?php } ?>
							</select>
						</div>
					</div>
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="mobile_no" value="<?php echo ($this->input->post('mobile_no') ? $this->input->post('mobile_no') : ''); ?>" class="form-control" id="mobile_no" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="comment" value="<?php echo ($this->input->post('comment') ? $this->input->post('comment') : ''); ?>" class="form-control" id="comment" />
						</div>
					</div>
